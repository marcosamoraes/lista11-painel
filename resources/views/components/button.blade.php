...
@php
    ...
    switch ($variant) {
        ...
        break;
        case 'secondary':
            $variantClasses = 'text-gray-500 bg-gray-200 hover:bg-gray-300 focus:ring-primary-500 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
