                ...
                <div class="mb-5 grid grid-cols-1 sm:grid-cols-3 gap-y-6 gap-x-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input
                            ...
                            type="text"
                            class="block w-full"
                            :value="old('created_at', $seller->created_at->format('d/m/Y H:i:s'))"
                            autofocus
                            disabled
                            readonly
                        />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input
                            ...
                            type="text"
                            class="block w-full"
                            :value="old('updated_at', $seller->updated_at->format('d/m/Y H:i:s'))"
                            autofocus
                            disabled
                            readonly
                        />
                ...
                <div class="mb-5 grid grid-cols-1 sm:grid-cols-5 gap-y-6 gap-x-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input
                            ...
                            type="text"
                            class="block w-full"
                            :value="old('seller.birth_date', $seller->birth_date ? $seller->birth_date->format('d/m/Y') : null)"
                            x-mask="99/99/9999"
                            autofocus
